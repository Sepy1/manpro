                        ...
                        <div class="sm:col-span-2 rounded-xl border border-amber-200/80 bg-amber-50/50 px-4 py-3 dark:border-amber-900/40 dark:bg-amber-950/20" x-transition>
                            <label class="flex cursor-pointer items-start gap-3 text-sm text-gray-800 dark:text-gray-100">
                                ...
                                <span>
                                    ...
                                    <span class="mt-1 block text-xs leading-relaxed text-gray-600 dark:text-gray-400">Jika dicentang, pengguna ini termasuk penerima notifikasi template Mahadata saat ada CR eksternal baru (perlu nomor WA valid). Tombol “Setuju” / “Tidak” diproses via webhook WhatsApp.</span>
                                </span>
                            </label>
                        </div>
                        <div>
                ...
                <div class="rounded-lg border border-amber-200/80 bg-amber-50/50 px-3 py-3 dark:border-amber-900/40 dark:bg-amber-950/20 md:col-span-7" x-transition>
                    <label class="flex cursor-pointer items-start gap-3 text-sm text-gray-800 dark:text-gray-100">
                        ...
                        <span>
                            ...
                            <span class="mt-0.5 block text-xs leading-relaxed text-gray-600 dark:text-gray-400">Centang untuk mengirim template WhatsApp (Mahadata) ke nomor ini saat CR eksternal baru dibuat. Tombol “Setuju” / “Tidak” diproses via webhook aplikasi.</span>
                        </span>
                    </label>
                </div>
