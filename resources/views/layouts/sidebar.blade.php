    ...
    <div class="pt-8 pb-7 flex"
        ...
        <a href="/">
            <span
                ...
                class="block text-lg font-bold leading-snug text-slate-800 dark:text-white/90"
            >
                Management Projects IT BKK Jateng
            </span>
            <span
                x-show="!$store.sidebar.isExpanded && !$store.sidebar.isHovered && !$store.sidebar.isMobileOpen"
                class="inline-flex h-8 w-8 items-center justify-center rounded-lg bg-brand-500 text-xs font-bold text-white"
            >
                PM
            </span>
        </a>
